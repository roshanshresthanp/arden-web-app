        ...
        <table>
            ...
            if ($totalQuestions > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $remark = ($userAnswer == $correct) ? 'Correct' : 'Incorrect';
                    $remarkClass = ($userAnswer == $correct) ? 'correct' : 'incorrect';
                    ...
                    echo "<td class='{$remarkClass}'>{$remark}</td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='5'>No questions found in the database.</td></tr>";
            }
